    ...
    return (
        <footer className="footer">
            <div className="footer__grid container grid">
                <div className="footer__content">
                    ...
                    <p className="footer__description">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam facilis ut reprehenderit quod, velit dicta doloremque numquam corrupti pariatur iure animi iste! Rem, laudantium ullam. Aspernatur, quis! Cum, temporibus ad!
                    </p>

                    <ul className="footer__contact">
                        <li className="footer__contact-item">
                            <AiOutlinePhone className='icon' /> +353 086 999 9999
                        </li>
                        <li className="footer__contact-item">
                            <MdOutlineLocationOn className='icon' /> Newbridge, Ireland
                        </li>
                        <li className="footer__contact-item">
            ...
            <p className="copyright__text">
                <span>Coffero</span> &copy; 2023. All Rights Reserved.
            </p>
        </footer>
    )
}
