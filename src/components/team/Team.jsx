...
import chef1 from "../../assets/img/team-1.jpg"
import chef2 from "../../assets/img/team-2.jpg"
import chef3 from "../../assets/img/team-3.jpg"
import chef4 from "../../assets/img/team-4.jpg"
        ...
        <section className="team section" id="team">
            ...
            <div className="team__grid grid container">
                ...
                <div className="team__item">
                    ...
                    <div className="team__data">
                        <h3 className="team__title">Arron Taylor</h3>
                        <p className="team__job">Senior Chef</p>
                    </div>
                ...
                <div className="team__item">
                    ...
                    <div className="team__data">
                        <h3 className="team__title">Jade Miller</h3>
                        <p className="team__job">Senior Chef</p>
                    </div>
